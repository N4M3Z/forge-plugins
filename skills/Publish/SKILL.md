...
name: Publish
version: 0.1.0
description: "Validate and publish forge modules as standalone Claude Code plugins. USE WHEN publish module, validate plugin, check plugin.json, marketplace readiness, release plugin, standalone plugin, publish to marketplace."
---
